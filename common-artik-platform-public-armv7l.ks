...
repo --name=base_arm --baseurl=http://download.tizen.org/releases/milestone/tizen/3.0.m2/3.0.m2-base/latest/repos/arm/packages/ --ssl_verify=no
#repo --name=common-wayland_armv7l --baseurl=file:///home/sblee/Tizen/artik-gbs/GBS-ROOT/local/repos/tizen3.0_common_artik/armv7l/RPMS/ --ssl_verify=no
